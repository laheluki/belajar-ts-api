...
class AddressService {
    static create(user, request) {
        return __awaiter(this, void 0, void 0, function* () {
            const createRequest = validation_1.Validation.validate(address_2.AddressValidation.CREATE, request);
            yield contact_1.ContactService.checkContactMustExists(user.username, request.contact_id);
    ...
    static get(user, request) {
        return __awaiter(this, void 0, void 0, function* () {
            const getRequest = validation_1.Validation.validate(address_2.AddressValidation.GET, request);
            yield contact_1.ContactService.checkContactMustExists(user.username, request.contact_id);
    ...
    static update(user, request) {
        return __awaiter(this, void 0, void 0, function* () {
            const updateRequest = validation_1.Validation.validate(address_2.AddressValidation.UPDATE, request);
            yield contact_1.ContactService.checkContactMustExists(user.username, request.contact_id);
    ...
    static remove(user, request) {
        return __awaiter(this, void 0, void 0, function* () {
            const removeRequest = validation_1.Validation.validate(address_2.AddressValidation.GET, request);
            yield contact_1.ContactService.checkContactMustExists(user.username, request.contact_id);
    ...
    static list(user, contactId) {
        return __awaiter(this, void 0, void 0, function* () {
            yield contact_1.ContactService.checkContactMustExists(user.username, contactId);
