...
const contact_2 = require("../validation/contact");
...
class ContactService {
    static create(user, request) {
        return __awaiter(this, void 0, void 0, function* () {
            const createRequest = validation_1.Validation.validate(contact_2.ContactValidation.CREATE, request);
    ...
    static update(user, request) {
        return __awaiter(this, void 0, void 0, function* () {
            const updateRequest = validation_1.Validation.validate(contact_2.ContactValidation.UPDATE, request);
    ...
    static search(user, request) {
        return __awaiter(this, void 0, void 0, function* () {
            const searchRequest = validation_1.Validation.validate(contact_2.ContactValidation.SEARCH, request);
